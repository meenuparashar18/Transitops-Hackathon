...
4. When you close the modal, the dashboard KPIs, operational cost ledgers, fuel efficiency stats, and SVG charts will refresh to display the newly simulated outco